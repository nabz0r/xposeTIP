...
DEFAULT_BLACKLIST = [
    ...
    # Generic web phrases that scrapers leak as names (S134 fix #1)
    {"pattern": "about me", "type": "exact", "reason": "about.me brand leak"},
    {"pattern": "home page", "type": "exact", "reason": "Generic web phrase"},
    {"pattern": "profile", "type": "exact", "reason": "Generic web phrase"},
    {"pattern": "home", "type": "exact", "reason": "Generic web phrase"},
    {"pattern": "log in", "type": "exact", "reason": "Auth UI label"},
    {"pattern": "sign up", "type": "exact", "reason": "Auth UI label"},
    {"pattern": "sign in", "type": "exact", "reason": "Auth UI label"},
    ...
    # Sprint 29 additions
    {"pattern": "booking", "type": "contains", "reason": "Travel platform"},
