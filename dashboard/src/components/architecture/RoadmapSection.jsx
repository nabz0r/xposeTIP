          ...
          {[
            {
              ...
              items: [
                ...
                { done: true, text: '139 OSINT sources across 11 categories (116 active / 23 pending validation)' },
                ...
                { done: true, text: 'Dual-avatar header — real photo + glyph badge (Snapchat-Bitmoji style)' },
                { done: true, text: 'Fingerprint Evolution timeline — scrollable 20-snapshot history' },
                { done: true, text: 'Three-pass pipeline: Email → Username expansion → Name enrichment' },
                { done: true, text: 'Phone + crypto wallet extraction from breach payloads' },
                { done: true, text: 'Public exposure: news, sanctions (40+ lists), corporate records' },
                { done: true, text: 'Legal records: Courtlistener (US), BODACC (FR), UK Gazette' },
                { done: true, text: 'Operator identity assertions (ground truth override)' },
                { done: true, text: 'TopoJSON geomap — country-density heatmap with zoom/pan' },
                { done: true, text: 'Cascade state machine — 4 visible states (gathering → computing → similarity → done)' },
                { done: true, text: 'DB-persisted similarity engine — 11-axis cosine, audit timestamps, BFP scaffolding' },
                { done: true, text: 'Web Discovery (Phase C) — fingerprint-driven Google dork crawling' },
