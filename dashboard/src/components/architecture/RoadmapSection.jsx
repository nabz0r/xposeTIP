          ...
          {[
            {
              ...
              items: [
                ...
                { done: true, text: '127 OSINT sources across 11 categories (110 active / 17 pending validation)' },
                ...
                { done: true, text: 'DB-persisted similarity engine — 9-axis cosine, audit timestamps, BFP scaffolding' },
