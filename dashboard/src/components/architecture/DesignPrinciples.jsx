        ...
        <div className="space-y-6">
          {[
            ...
            },
            {
              ...
              desc: `Maximum insight per watt. ${SOURCE_COUNT} scrapers, PageRank, Markov chains — on a single machine. No GPU clusters, no cloud bloat. Data-driven scrapers (JSON config, not code per source). Pixel art avatars: 5.4B combos, zero GPU. Every decision asks: is this the lightest way?`,
            },
          ].map(p => (
