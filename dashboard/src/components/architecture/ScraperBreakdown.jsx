  ...
  return (
    <Section className="py-20 bg-[#12121a]/50">
      <div className="max-w-3xl mx-auto px-6">
        <h2 className="text-2xl font-bold mb-8 text-center font-['Instrument_Sans',sans-serif]">176 Intelligence Sources</h2>
        <div className="bg-[#0a0a0f] border border-[#1e1e2e] rounded-xl overflow-hidden">
          {[
            ...
            { cat: 'Identity',        count: 10, color: '#00ff88', examples: 'Agify, Genderize, Nationalize, NumVerify, Veriphone, API Ninjas, AbstractAPI, GitHub SSH keys, GitLab SSH keys' },
          ...
          <div className="flex items-center gap-4 px-5 py-3 bg-[#1e1e2e]/30">
            ...
            <span className="text-sm font-mono font-bold w-8 text-center text-[#00ff88]">176</span>
