  ...
  return (
    <Section className="py-20 bg-[#12121a]/50">
      <div className="max-w-3xl mx-auto px-6">
        <h2 className="text-2xl font-bold mb-8 text-center font-['Instrument_Sans',sans-serif]">139 Intelligence Sources</h2>
        <div className="bg-[#0a0a0f] border border-[#1e1e2e] rounded-xl overflow-hidden">
          {[
            ...
            { cat: 'Identity', count: 6, color: '#cc88ff', examples: 'Agify, Genderize, Nationalize, NumVerify (phone), Veriphone (phone)' },
          ...
          <div className="flex items-center gap-4 px-5 py-3 bg-[#1e1e2e]/30">
            ...
            <span className="text-sm font-mono font-bold w-8 text-center text-[#00ff88]">139</span>
          ...
          <div className="flex items-center gap-4 px-5 py-2 bg-[#1e1e2e]/10 border-t border-[#1e1e2e]">
            ...
            <span className="text-xs font-mono w-16 text-center"><span className="text-[#00ff88]">116</span><span className="text-gray-600"> / </span><span className="text-gray-500">23</span></span>
            <span className="text-[10px] text-gray-600">83% activation rate · disabled = pending API key or pending validation</span>
          </div>
        </div>
      </div>
    </Section>
