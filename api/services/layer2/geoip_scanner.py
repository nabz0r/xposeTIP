            ...
            for ip in ips:
                try:
                    ...
                    results.append(ScanResult(
                        ...
                        category="geolocation",
                        severity="info",
                        title=f"Mail server location: {city}, {country}",
                        description=f"Mail server IP {ip} for domain {domain} geolocated to {city}, {country} ({data.get('isp', '')}). This is the server location, not the user's location.",
                        data=geo_data,
                        indicator_value=ip,
                        indicator_type="ip",
                        verified=True,
