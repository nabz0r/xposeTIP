...
[![Scrapers](https://img.shields.io/badge/scrapers-170-3388ff)](#scraper-engine)
...
| Layer | What | How |
|:-----:|------|-----|
| **L1** | Passive Recon | 170 scrapers: account enumeration, breach history, social profiles, username expansion, phone/crypto enrichment, legal records (US/FR/UK + SEC EDGAR + Companies House UK), academic identity (arXiv/ORCID/DBLP/Semantic Scholar) |
...
- **Web Discovery (Phase C)** — fingerprint-driven Google dorking + 6 content extractors — explores the open web beyond the 170 fixed scrapers
...
170 data-driven scrapers (145 active by default, 25 disabled) — all configurable via UI (URL template, extraction rules, rate limits):
...
graph LR
    ...
    C --> P1[Phase A — Gather<br/>170 scrapers + Pass 1.5 + Pass 2]
...
| Starter | €49/mo | 250 | 1 | Full 170-source pipeline, identity graph + personas, PDF reports |
