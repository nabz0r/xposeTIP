...
| formal_records | 47 | 0.000 | 0.000 | 0.000 | 0.000 | 100.0 | 0.0 | 0.000 | 0.000 | 0.000 |
| network_signature | 47 | 0.825 | 0.006 | 0.806 | 0.832 | 0.0 | 0.0 | 0.816 | 0.827 | 0.830 |
...
| formal_records (`formal_records_raw`, max=5) | 47 | 0.000 | 0.000 | 0.000 | 0.000 | 0.0 | 0.000 | 0.000 | 0.000 |
| network_signature (`network_signature_raw`, max=1.0) | 47 | 0.825 | 0.006 | 0.806 | 0.832 | 0.0 | 0.816 | 0.827 | 0.830 |
...
|--:|--:|---|---|---|
| 1 | 1.000 | `sebastien.labbe@bgl.lu` | `vincent.delfosse@bgl.lu` | network_signature, username_reuse, breaches |
| 2 | 1.000 | `sebastien.labbe@bgl.lu` | `frederic.kieffer@bgl.lu` | network_signature, username_reuse, breaches |
| 3 | 1.000 | `cedric.bossaert@bgl.lu` | `pauline.monginot@bgl.lu` | network_signature, username_reuse, breaches |
| 4 | 1.000 | `marc.lennert@bgl.lu` | `alain.nyckees@bgl.lu` | network_signature, username_reuse, breaches |
| 5 | 1.000 | `hichem.safar@bgl.lu` | `gilles.scholtus@bgl.lu` | network_signature, username_reuse, breaches |
| 6 | 1.000 | `patrice.maraschi@bgl.lu` | `sandrine.devuyst@bgl.lu` | network_signature, username_reuse, breaches |
| 7 | 1.000 | `patrice.maraschi@bgl.lu` | `valerie.sini@bgl.lu` | network_signature, username_reuse, breaches |
| 8 | 1.000 | `francoise.thoma@bgl.lu` | `gregory.gillet@bgl.lu` | network_signature, username_reuse, breaches |
| 9 | 1.000 | `vincent.delfosse@bgl.lu` | `frederic.kieffer@bgl.lu` | network_signature, username_reuse, breaches |
| 10 | 1.000 | `sandrine.devuyst@bgl.lu` | `valerie.sini@bgl.lu` | network_signature, username_reuse, breaches |
| 11 | 1.000 | `sebastien.labbe@bgl.lu` | `marc.lennert@bgl.lu` | network_signature, username_reuse, breaches |
| 12 | 1.000 | `sebastien.labbe@bgl.lu` | `alain.nyckees@bgl.lu` | network_signature, username_reuse, breaches |
| 13 | 1.000 | `cedric.bossaert@bgl.lu` | `marc.lennert@bgl.lu` | network_signature, username_reuse, breaches |
| 14 | 1.000 | `cedric.bossaert@bgl.lu` | `francoise.thoma@bgl.lu` | network_signature, username_reuse, breaches |
| 15 | 1.000 | `cedric.bossaert@bgl.lu` | `gregory.gillet@bgl.lu` | network_signature, username_reuse, breaches |
| 16 | 1.000 | `cedric.bossaert@bgl.lu` | `alain.nyckees@bgl.lu` | network_signature, username_reuse, breaches |
| 17 | 1.000 | `pauline.monginot@bgl.lu` | `marc.lennert@bgl.lu` | network_signature, username_reuse, breaches |
| 18 | 1.000 | `pauline.monginot@bgl.lu` | `francoise.thoma@bgl.lu` | network_signature, username_reuse, breaches |
| 19 | 1.000 | `pauline.monginot@bgl.lu` | `gregory.gillet@bgl.lu` | network_signature, username_reuse, breaches |
| 20 | 1.000 | `pauline.monginot@bgl.lu` | `alain.nyckees@bgl.lu` | network_signature, username_reuse, breaches |
