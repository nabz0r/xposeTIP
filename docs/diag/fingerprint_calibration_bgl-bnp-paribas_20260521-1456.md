...
|--:|--:|---|---|---|
| 1 | 1.000 | `sebastien.labbe@bgl.lu` | `vincent.delfosse@bgl.lu` | username_reuse, breaches, accounts |
| 2 | 1.000 | `sebastien.labbe@bgl.lu` | `frederic.kieffer@bgl.lu` | username_reuse, breaches, accounts |
| 3 | 1.000 | `cedric.bossaert@bgl.lu` | `pauline.monginot@bgl.lu` | username_reuse, breaches, accounts |
| 4 | 1.000 | `hichem.safar@bgl.lu` | `gilles.scholtus@bgl.lu` | username_reuse, breaches, accounts |
| 5 | 1.000 | `marc.lennert@bgl.lu` | `alain.nyckees@bgl.lu` | username_reuse, breaches, accounts |
| 6 | 1.000 | `patrice.maraschi@bgl.lu` | `sandrine.devuyst@bgl.lu` | username_reuse, breaches, accounts |
| 7 | 1.000 | `patrice.maraschi@bgl.lu` | `valerie.sini@bgl.lu` | username_reuse, breaches, accounts |
| 8 | 1.000 | `francoise.thoma@bgl.lu` | `gregory.gillet@bgl.lu` | username_reuse, breaches, accounts |
...
| 11 | 1.000 | `sebastien.labbe@bgl.lu` | `marc.lennert@bgl.lu` | username_reuse, breaches, accounts |
| 12 | 1.000 | `sebastien.labbe@bgl.lu` | `alain.nyckees@bgl.lu` | username_reuse, breaches, accounts |
| 13 | 1.000 | `cedric.bossaert@bgl.lu` | `marc.lennert@bgl.lu` | username_reuse, breaches, accounts |
| 14 | 1.000 | `cedric.bossaert@bgl.lu` | `alain.nyckees@bgl.lu` | username_reuse, breaches, accounts |
| 15 | 1.000 | `pauline.monginot@bgl.lu` | `marc.lennert@bgl.lu` | username_reuse, breaches, accounts |
| 16 | 1.000 | `pauline.monginot@bgl.lu` | `alain.nyckees@bgl.lu` | username_reuse, breaches, accounts |
| 17 | 1.000 | `hichem.safar@bgl.lu` | `tajana.zidani@bgl.lu` | username_reuse, breaches, accounts |
| 18 | 1.000 | `hichem.safar@bgl.lu` | `patrice.maraschi@bgl.lu` | username_reuse, breaches, accounts |
| 19 | 1.000 | `hichem.safar@bgl.lu` | `sandrine.devuyst@bgl.lu` | username_reuse, breaches, accounts |
| 20 | 1.000 | `hichem.safar@bgl.lu` | `valerie.sini@bgl.lu` | username_reuse, breaches, accounts |
