...
| network_signature | 12 | 0.816 | 0.005 | 0.810 | 0.824 | 0.0 | 0.0 | 0.810 | 0.815 | 0.823 |
...
| network_signature (`network_signature_raw`, max=1.0) | 12 | 0.816 | 0.005 | 0.810 | 0.824 | 0.0 | 0.811 | 0.815 | 0.823 |
...
**Threshold sanity:** 96.97% of pairs ≥ 0.7. If > 5% → threshold likely too low. If < 0.1% → threshold too high or vectors too noisy.

## F — Top 20 highest-similarity pairs (fresh recompute)

| rank | sim | target a (email) | target b (email) | top-3 co-axes |
|--:|--:|---|---|---|
| 1 | 0.990 | `akim@threatconnect.com` | `dcole@threatconnect.com` | network_signature, geo_spread, accounts |
| 2 | 0.989 | `hbrandon@threatconnect.com` | `jsjones@threatconnect.com` | network_signature, accounts, platforms |
| 3 | 0.987 | `tbhullar@threatconnect.com` | `jmcfadyen@threatconnect.com` | network_signature, breaches, accounts |
| 4 | 0.986 | `hbrandon@threatconnect.com` | `jmcfadyen@threatconnect.com` | network_signature, breaches, accounts |
| 5 | 0.983 | `jjacobs@threatconnect.com` | `moblack@threatconnect.com` | network_signature, platforms, accounts |
| 6 | 0.981 | `hbrandon@threatconnect.com` | `tbhullar@threatconnect.com` | network_signature, breaches, accounts |
| 7 | 0.980 | `dtineo@threatconnect.com` | `tbhullar@threatconnect.com` | network_signature, breaches, accounts |
| 8 | 0.980 | `byelamanchili@threatconnect.com` | `dtineo@threatconnect.com` | network_signature, breaches, geo_spread |
| 9 | 0.974 | `dtineo@threatconnect.com` | `jmcfadyen@threatconnect.com` | network_signature, breaches, accounts |
| 10 | 0.968 | `btomes@threatconnect.com` | `dtineo@threatconnect.com` | network_signature, breaches, accounts |
| 11 | 0.966 | `hbrandon@threatconnect.com` | `moblack@threatconnect.com` | network_signature, accounts, platforms |
| 12 | 0.966 | `btomes@threatconnect.com` | `jsjones@threatconnect.com` | network_signature, breaches, platforms |
| 13 | 0.965 | `btomes@threatconnect.com` | `tbhullar@threatconnect.com` | network_signature, breaches, platforms |
| 14 | 0.964 | `moblack@threatconnect.com` | `tbhullar@threatconnect.com` | network_signature, breaches, accounts |
| 15 | 0.960 | `jmcfadyen@threatconnect.com` | `jsjones@threatconnect.com` | network_signature, breaches, accounts |
| 16 | 0.960 | `hbrandon@threatconnect.com` | `dtineo@threatconnect.com` | network_signature, breaches, accounts |
| 17 | 0.960 | `btomes@threatconnect.com` | `jmcfadyen@threatconnect.com` | network_signature, breaches, accounts |
| 18 | 0.960 | `byelamanchili@threatconnect.com` | `btomes@threatconnect.com` | network_signature, breaches, geo_spread |
| 19 | 0.958 | `jjacobs@threatconnect.com` | `tbhullar@threatconnect.com` | network_signature, breaches, accounts |
| 20 | 0.957 | `hbrandon@threatconnect.com` | `btomes@threatconnect.com` | network_signature, breaches, platforms |
...
- similarity threshold sanity: 96.97% of pairs ≥ 0.7 → threshold likely too low
