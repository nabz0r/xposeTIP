...
| 10 | 0.971 | `mbrash@threatconnect.com` | `ewray@threatconnect.com` | breaches, accounts, platforms |
...
| 19 | 0.927 | `mbrash@threatconnect.com` | `cpugalis@threatconnect.com` | breaches, geo_spread, accounts |
