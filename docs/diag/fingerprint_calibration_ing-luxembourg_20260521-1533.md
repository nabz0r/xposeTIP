...
| network_signature | 3 | 0.820 | 0.001 | 0.819 | 0.821 | 0.0 | 0.0 | 0.818 | 0.821 | 0.821 |
...
| network_signature (`network_signature_raw`, max=1.0) | 3 | 0.820 | 0.001 | 0.819 | 0.821 | 0.0 | 0.817 | 0.821 | 0.822 |
...
|--:|--:|---|---|---|
| 1 | 0.999 | `laura.morgana@ing.lu` | `marceau.muller@ing.lu` | network_signature, username_reuse, breaches |
| 2 | 0.994 | `marceau.muller@ing.lu` | `laura.morgano@ing.lu` | network_signature, username_reuse, breaches |
| 3 | 0.994 | `laura.morgana@ing.lu` | `laura.morgano@ing.lu` | network_signature, username_reuse, breaches |
