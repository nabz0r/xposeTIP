...
| network_signature | 8 | 0.802 | 0.015 | 0.775 | 0.817 | 0.0 | 0.0 | 0.774 | 0.807 | 0.817 |
...
| network_signature (`network_signature_raw`, max=1.0) | 8 | 0.802 | 0.015 | 0.775 | 0.817 | 0.0 | 0.774 | 0.807 | 0.817 |
...
|--:|--:|---|---|---|
| 1 | 0.993 | `booking.lxb@gmail.com` | `abed.belaid@gmail.com` | network_signature, security, username_reuse |
| 2 | 0.982 | `camelia.belab@gmail.com` | `abed.belaid@gmail.com` | network_signature, breaches, security |
| 3 | 0.980 | `booking.lxb@gmail.com` | `camelia.belab@gmail.com` | network_signature, security, username_reuse |
| 4 | 0.969 | `Ksontinisarah@gmail.com` | `loupn24@msn.com` | breaches, network_signature, security |
| 5 | 0.950 | `loupn24@msn.com` | `guillaume.a.perrin@gmail.com` | breaches, network_signature, formal_records |
| 6 | 0.920 | `camelia.belab@gmail.com` | `info@florencehoffmann.net` | network_signature, breaches, security |
| 7 | 0.920 | `Ksontinisarah@gmail.com` | `guillaume.a.perrin@gmail.com` | breaches, network_signature, security |
| 8 | 0.897 | `nabz0r@gmail.com` | `info@florencehoffmann.net` | breaches, network_signature, security |
| 9 | 0.892 | `Ksontinisarah@gmail.com` | `camelia.belab@gmail.com` | breaches, network_signature, security |
| 10 | 0.887 | `Ksontinisarah@gmail.com` | `nabz0r@gmail.com` | breaches, network_signature, security |
| 11 | 0.881 | `abed.belaid@gmail.com` | `info@florencehoffmann.net` | network_signature, breaches, security |
| 12 | 0.880 | `Ksontinisarah@gmail.com` | `abed.belaid@gmail.com` | breaches, network_signature, security |
| 13 | 0.880 | `camelia.belab@gmail.com` | `nabz0r@gmail.com` | breaches, network_signature, security |
| 14 | 0.879 | `Ksontinisarah@gmail.com` | `info@florencehoffmann.net` | breaches, network_signature, security |
| 15 | 0.873 | `camelia.belab@gmail.com` | `loupn24@msn.com` | network_signature, breaches, security |
| 16 | 0.868 | `Ksontinisarah@gmail.com` | `booking.lxb@gmail.com` | network_signature, security, breaches |
| 17 | 0.867 | `loupn24@msn.com` | `info@florencehoffmann.net` | network_signature, breaches, security |
| 18 | 0.865 | `booking.lxb@gmail.com` | `info@florencehoffmann.net` | network_signature, security, breaches |
| 19 | 0.853 | `loupn24@msn.com` | `abed.belaid@gmail.com` | network_signature, breaches, security |
| 20 | 0.836 | `booking.lxb@gmail.com` | `loupn24@msn.com` | network_signature, breaches, security |
