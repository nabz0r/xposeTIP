...
|--:|--:|---|---|---|
| 1 | 1.000 | `drkavichopra@gmail.com` | `gmelahaye@gmail.com` | security, breaches, geo_spread |
...
| 4 | 0.997 | `drkavichopra@gmail.com` | `guillaumelahaye@glgroup.fr` | security, breaches, geo_spread |
| 5 | 0.997 | `gmelahaye@gmail.com` | `guillaumelahaye@glgroup.fr` | security, breaches, geo_spread |
| 6 | 0.995 | `vihihid@gmail.com` | `juliefranck@gmail.com` | breaches, security, platforms |
| 7 | 0.995 | `drkavichopra@gmail.com` | `g.lahaye.glimmobilier@gmail.com` | security, breaches, geo_spread |
| 8 | 0.995 | `drkavichopra@gmail.com` | `drbastin38@gmail.com` | security, breaches, geo_spread |
| 9 | 0.995 | `gmelahaye@gmail.com` | `g.lahaye.glimmobilier@gmail.com` | security, breaches, geo_spread |
| 10 | 0.995 | `gmelahaye@gmail.com` | `drbastin38@gmail.com` | security, breaches, geo_spread |
| 11 | 0.995 | `adrienfargue@gmail.com` | `davidastratoff@gmail.com` | breaches, security, accounts |
| 12 | 0.994 | `adrienfargue@gmail.com` | `juliefranck@gmail.com` | breaches, security, platforms |
