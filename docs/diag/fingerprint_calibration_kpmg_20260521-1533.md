...
| network_signature | 2 | 0.819 | 0.001 | 0.818 | 0.820 | 0.0 | 0.0 | 0.817 | 0.819 | 0.821 |
...
| network_signature (`network_signature_raw`, max=1.0) | 2 | 0.819 | 0.001 | 0.818 | 0.820 | 0.0 | 0.817 | 0.819 | 0.821 |
...
|--:|--:|---|---|---|
| 1 | 0.993 | `nicolas.huynen@kpmg.lu` | `benjamin.lavault@kpmg.lu` | network_signature, username_reuse, breaches |
