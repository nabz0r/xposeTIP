...
| network_signature | 3 | 0.858 | 0.077 | 0.805 | 0.946 | 0.0 | 0.0 | 0.794 | 0.824 | 1.019 |
...
| network_signature (`network_signature_raw`, max=1.0) | 3 | 0.859 | 0.077 | 0.805 | 0.946 | 0.0 | 0.794 | 0.824 | 1.020 |
...
|--:|--:|---|---|---|
| 1 | 0.992 | `bobyblues@gmail.com` | `loupn24@msn.com` | network_signature, security, geo_spread |
| 2 | 0.978 | `bobyblues@gmail.com` | `jon.doe@gmail.com` | network_signature, security, geo_spread |
| 3 | 0.962 | `jon.doe@gmail.com` | `loupn24@msn.com` | network_signature, security, geo_spread |
