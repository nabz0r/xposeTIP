...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| accounts | 3 | 0.178 | 0.192 | 0.067 | 0.400 | 0.0 | 0.0 | 0.067 | 0.067 | 0.600 |
...
| data_leaked | 3 | 0.333 | 0.361 | 0.125 | 0.750 | 0.0 | 0.0 | 0.125 | 0.125 | 1.125 |
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| accounts (`accounts`, max=15) | 3 | 2.667 | 2.887 | 1.000 | 6.000 | 0.0 | 1.000 | 1.000 | 9.000 |
| platforms (`platforms`, max=10) | 3 | 0.000 | 0.000 | 0.000 | 0.000 | 0.0 | 0.000 | 0.000 | 0.000 |
| username_reuse (`username_reuse`, max=5) | 3 | 0.000 | 0.000 | 0.000 | 0.000 | 0.0 | 0.000 | 0.000 | 0.000 |
...
| data_leaked (`data_leaked`, max=8) | 3 | 2.667 | 2.887 | 1.000 | 6.000 | 0.0 | 1.000 | 1.000 | 9.000 |
| email_age (`email_age_years`, max=15) | 3 | 0.000 | 0.000 | 0.000 | 0.000 | 0.0 | 0.000 | 0.000 | 0.000 |
...
|--:|--:|---|---|---|
| 1 | 0.996 | `bobyblues@gmail.com` | `loupn24@msn.com` | security, data_leaked, accounts |
| 2 | 0.841 | `jon.doe@gmail.com` | `loupn24@msn.com` | security, data_leaked, accounts |
| 3 | 0.790 | `bobyblues@gmail.com` | `jon.doe@gmail.com` | security, data_leaked, accounts |
