> **ARCHIVE — Nexus 2026 narrative (rejected May 2026, kept for historical reference).**
> Current demo guidance lives in `DEMO_SCRIPT.md`. The Nexus framing ("investigation tool", event-specific) is no longer the public positioning. See `docs/SPRINT_LOG.md` entries S113 + S130 for the pivot.
